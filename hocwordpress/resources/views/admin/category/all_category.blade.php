      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            <a onclick="return confirm('Bạn có chắc chắn muốn xóa danh mục này không?')" href="{{URL::to('/delete-category/'.$cate->category_id)}}" class="active styling-edit" ui-toggle-class="">  
